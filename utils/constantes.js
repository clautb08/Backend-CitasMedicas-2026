...
export const JWT_SECRET=process.env.JWT_SECRET || 'default-jwt-secret-2026';
...
export const JWT_REFRESH_SECRET=process.env.JWT_REFRESH_SECRET || 'default-jwt-refresh-2026';
